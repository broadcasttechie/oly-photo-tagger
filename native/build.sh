...
#
# Adapted from bestvibes/exiftoolwrapper-android (MIT License), which solved
# this exact problem — cross-compiling perl for Android via perl-cross,
# packaging ExifTool as native jniLibs — reproducibly and with real
# provenance. See native/NOTICE for the full license text and origin.
# Adapted here for this app's package name and narrower use case (a fixed
# GPS-write invocation rather than a general exiftool command UI).
#
# Usage:
...
build_perl_for_abi() {
    ...
    (
        ...
        local runtime_perl5="/data/data/com.olyphototagger.app/files/perl5"
    ...
    local install_root="${work}/install/data/data/com.olyphototagger.app/files/perl5"
